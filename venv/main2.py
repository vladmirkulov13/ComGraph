...
if __name__ == "__main__":
    ...
    h, w = 1000, 1000
    im6 = Image.new('L', (h, w))
    # в этих циклах строятся полигоны по номерам точек, считанным из файла Test.obj
    # так как там три точки в массиве, строится треугольник попарна соединяя эти точки между собой
    # был выбран первый алгоритм отрисовки линий, так как Брезенхема не работал и было тяжко найти
    # где конкретно падал
